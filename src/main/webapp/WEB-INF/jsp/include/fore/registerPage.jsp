...
<div id="registerDiv" style="position: relative">	
	<form class="registerForm" action="foreregister" method="post">
		<div id="registerSmallDiv" class="registerSmallDiv">
			...
			<div class="registerTable"  align="center">
				<table class="registerTable" >
					...
					<tr>
						...
						<td class="registerTableRightTD"><strong>登录时保护账号信息</strong></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2" class="registerButtonTD"><a
							href="registerSuccess.jsp"><button>注 册</button></a></td>
					</tr>
				</table>
			</div>
		</div>
