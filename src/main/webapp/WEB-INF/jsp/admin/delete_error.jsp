...
<c:if test="${delete_check == 'property_delete' }">
	...
	<div class="workingArea">
		...
		<span class="text-danger"><h1 align="center">警告</h1></span>
		<div align="center">
			<font size="+2"><strong>你刚才执行了一个删除属性操作，删除的属性实例是分类</strong></font>
			<font color = "#483D8B" size="+4"><strong>“${category.name}”</strong></font>
			<font size="+2">下的“${delete_instance.name}”</strong></font><br /><br/> 
			<font size="+2"><strong>然而分类</strong></font>
			<font color = "#483D8B" size="+4"><strong>${category.name}</strong></font>
			<font size="+2"><strong>下还有其他产品，不可直接此属性删除。请删除分类
			<font color = "#483D8B" size="+4"><strong>${category.name}</strong></font>
...
<c:if test="${delete_check == 'category_delete' }">
	...
	<div class="workingArea">
		...
		<span class="text-danger"><h1 align="center">警告</h1></span>
		<div align="center">
			<font size="+2"><strong>你刚才执行了一个删除分类操作，删除的分类实例是“${delete_instance.name}”</strong></font><br />
